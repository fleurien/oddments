...
<h1>Add Birthday</h1>
<p>Your account does not have a birth date. To gain access to personalised site features, you must add a birthdate to your {{ config('lorekeeper.settings.site_name', 'Oddments') }} account. Your birthday is used to verify if you are allowed to access this site.
