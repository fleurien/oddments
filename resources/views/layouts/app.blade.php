...
<head>
    ...
    <title>{{ config('lorekeeper.settings.site_name', 'Oddments') }} -@yield('title')</title>

    <!-- Primary Meta Tags -->
    <meta name="title" content="{{ config('lorekeeper.settings.site_name', 'Oddments') }} -@yield('title')">
    <meta name="description" content="@if(View::hasSection('meta-desc')) @yield('meta-desc') @else {{ config('lorekeeper.settings.site_desc', 'A Oddments ARPG') }} @endif">
    ...
    <meta property="og:title" content="{{ config('lorekeeper.settings.site_name', 'Oddments') }} -@yield('title')">
    <meta property="og:description" content="@if(View::hasSection('meta-desc')) @yield('meta-desc') @else {{ config('lorekeeper.settings.site_desc', 'A Oddments ARPG') }} @endif">
    ...
    <meta property="twitter:title" content="{{ config('lorekeeper.settings.site_name', 'Oddments') }} -@yield('title')">
    <meta property="twitter:description" content="@if(View::hasSection('meta-desc')) @yield('meta-desc') @else {{ config('lorekeeper.settings.site_desc', 'A Oddments ARPG') }} @endif">
