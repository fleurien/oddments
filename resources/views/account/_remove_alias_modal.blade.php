...
@else
    ...
    <p>This will not affect characters that you own, and art/design credits credited to your {{ config('lorekeeper.settings.site_name', 'Oddments') }} account will remain intact. Are you sure?</p>
